import type { GeoCodingReverseData, WeatherData } from "@/api/types"
...
interface CurrentWeatherProps {
    data: WeatherData,
    locationName?: GeoCodingReverseData
        ...
        <CardContent className="p-6">
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="flex flex-col items-center justify-center ">
                    <div className="relative flex aspect-square items-center justify-center w-full max-w-50">
